...
??? note "Map Chests - A1, A3-4" 
    ...
    === "Guide" 
        ...
        - Go to the appropriate Abyss and collect your items.

    === "Technical Notes" 
        - The steps work for A1 and A3-4. 
...
??? note "Map Chests - A2"
    ...
    === "Guide" 
        ...
        - Do NOT "Leap" yet. 
        - Scroll back to the top of the screen and toggle left to A1 (The Beginning Abyss). 
        - Select "Fresh Start" and "Leap". 
        - Fastest dialogue options are "No problem" and "Do nothing".
        - Return to the Ruins and toggle back to the A2 timeline. 
