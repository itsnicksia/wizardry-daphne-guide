...
| Will Featured Adventurers be added to the Permanent Banner?                   | ~~Drecom has announced that they will, but none have been added as of December 2025.~~ As of January 15, 2026, the Permanent Banner was changed.  Adventurer's Remains and Legenendary Adventurur's Remains were split into a Type I and Type II.  Type I retains the original set of General and Legendary Adventurers (Lanavaille, Alice, Adam, Yekaterina, Gerulf, Debra), while Type II Adventurer's Remains also includes the Greedy Saintess Marianne alternate style, and the possible Legendaries pulls are Wanderer Princess Lanavaille, Gerard, Abenius, Red Beard, Rinne, and Savia.  Most in game remains still appear as Type I, but Adventurer's Remains (not Legendary Remains) can be freely exchanged between the two Types in the Ruins. Additionally, reversing Type I and Type II remains in the ruins now give tokens that can be redeemed at the Jeweler exchange for various items costing up to 150 tokens each. The exchange resets monthly but tokens carry over.|
