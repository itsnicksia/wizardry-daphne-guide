...
No, you don't need to be the same class as passives that list a class in parantheses. These parantheses just indicate origin of where the passive came from (and allow inheriting multiple similar skills from different sources). Angled brackets in the skill description, such as \<Knight-specific\> indicate that use of the skill is limited to that specific class.
