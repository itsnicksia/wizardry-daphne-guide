...
- Requires clearing the second run ("true" ending) of the [Stolen Armor Retrieval](../labyrinth-of-fordraig/labyrinth-of-fordraig-guide.md) special request. That request is unlocked after a first run of Abyss 2.

### Overview

- Request can be accepted in the Royal Capital under the Featured Requests tab. It is available for a limited time (until 3/11 23:59 JST).
- The goal of the request is to revisit the Labyrinth of Fordaig and collect the bodies of 11 adventurers scattered across all 4 floors.
...
- The yellow check-marks are the locations of each body.
- Note that 2 of the bodies are accessed via the purple teleporters located on B1F (by the Harken) and B4F (SE corner).
