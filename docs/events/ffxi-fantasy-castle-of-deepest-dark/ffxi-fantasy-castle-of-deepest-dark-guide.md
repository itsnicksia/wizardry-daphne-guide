...
!!! note "To properly solve this puzzle, you will need to make sure everyone besides the MC in the party are the same personality type, and then pick the door that matches that type. This way, no one is punished and no one gets angry at you. This will also register a toggle in the CW."
