...
!!! note "To solve the 3-door puzzle you need to bring adventurers whose alignment matches the corresponding door (Good-Neutral-Evil). Everyone besides the MC must be the same alignment. For the Cursed Wheel toggle to register properly you need to defeat Ulmia and unlock the next Harken. It operates very similarly to the corrosion sentry registration in A3."  
