...
??? note "Tips"
    ...
    - The boss fights are all mimics. 

??? danger "Beginner Difficulty Fight Tips"
    - It's a normal mimic. It will always go first with "Sudden Attack" dealing a small amount of damage.
...
??? danger "Intermediate Difficulty Fight Tips"
    - It's a normal mimic. It will always go first with "Sudden Attack" dealing a decent amount of damage.
    - It has very little HP but cannot be suretied.
    - It can be evaded after the initial attack.
    
??? danger "Advanced Difficulty Fight Tips"
    - It's a gold mimic. It will always go first with "Sudden Attack" dealing a decent amount of damage.
