...
??? info "TheAxolotl's Analysis"
    ...
    Her passive, Foxfire Assault, provides a party-wide debuff with an effective magnitude of roughly 5% increased damage to things she hits for the first 3 turns. Since it's a debuff, it is subject to extension from Alice inherits, so definitely give her some of those! Since it is a debuff, be mindful of the 3 debuff limit during those first turns. The duration is 1 turn by default, so even though she can only trigger it during the first three turns, Alice inherits will take that to 4 or 5 turns respectively. Keep in mind that this is enemy turns and not her turns, so enemies that perform two consecutive actions will have this duration shortened.
