...
??? info "TheAxolotl's Analysis"
    ...
    === "Standard"
        ...
        His passive, Return from the Six Realms, is a bit of an inverted but ramped up Flutterdream Flash. It stacks up to 50 and gains 8 stacks if he gets hit, 5 stacks if he gets attacked but evades, and 2 stacks if an ally gets attacked. When it reaches the maximum 50, he'll attack a random target. Similarly, these stacks also contribute to his ability to cheat death once and counter with the attack. While this attack does deal "major" damage, the ramp-up is variable and on short fights, will likely never fire off.
