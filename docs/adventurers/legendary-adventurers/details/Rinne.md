...
??? info "TheAxolotl's Analysis"
    ...
    === "Blade of Eternal Darkness"
        ...
        I'm a bit torn on this one. Rinne is one of my favorite characters, and while I'm not disappointed per se, I do think her alt form leaves a lot to be desired.

        First, Threefold Mist is pretty solid - it's essentially a better version of Unending Deaths, Continuous Funerals. For Ninjato Rinne, this skill actually observes increased softcaps, so not only will it get an additional hit over Unending, but each hit will also deal more damage. A big win here since the skill enables multi-target damage across rows, while her standard MoF is row-locked. While it doesn't fully replace MoF, it will likely become the go-to multitarget skill, relegating MoF to more situational uses.
