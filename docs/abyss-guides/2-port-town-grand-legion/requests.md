...
??? note "Accepting the Request (all factions)"
...
??? note "Travel to Viscount Guane's lands"
    1. Head to Viscount Guane's lands from the World Map
    ...
    2. Now talk to all the NPCs.
        
        ![](img/viscount_town_npcs.jpg)

??? note "Walkthrough - Princess Route"
    1. "I don't think so"
...
??? note "Walkthrough -  Pontiff Route"
...
??? note "Walkthrough - Admiral Route"
...
- To obtain this request, talk to the chef across from Reprobus on Lower Deck 1 after losing to him.  
...
- Collect Sahuagin Scales in Port Town Grand Legion Abyss through any means available to you.
    ...
    - Get them as token gifts from the [Faction Wandering NPC](./wandering-npcs.md/#faction-npc)  
