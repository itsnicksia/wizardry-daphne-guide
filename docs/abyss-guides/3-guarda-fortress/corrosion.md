...
## [1] Secret Passage Minor Harken - Zone 1
...
## "[2] Enshadowed Well of Life - Zone 3"
...
??? note "Cursed Wheel Registration"
    ...
    === "Not Spotted"
        ...
        !!! tip "Time-saving Tip"
            - Head south from the Zone 2 Fountain to register corrosion sentries [3] and [4]
    ...
    === "How to exit from the Zone 2 Fountain"
...
!!! warning
    - Corrosion sentries [3] and [4] are both listed under this node
...
### "[3] South Corrosion Sentry - Zone 2"
...
### "[4] Central Corrosion Sentry - Zone 2"
...
## "[5] Fortress Lower Floors Cleared - Zone 5"
...
## "[6] Portrait Gallery Minor Harken - Zone 6"
...
## "[7] Ghosts of Yore Vanquished - Corrosion Sentry - Zone 7"
...
## [8] 2F North Corrosion Sentry - Zone 9"
...
## "[9] 3F West Corrosion Sentry - Zone 10"

!!! warning "Warning"
    - Mandatory mini-quest required (see "Winding key locations")
...
??? note "Cursed Wheel Registration"
    ...
    === "Not Spotted"
        ...
        - In this new room examine the skeleton on the floor, which will spawn a broken automaton doll and a map on the floor nearby
        - The map will mark 3 locations on the previous floors (Zones 8 and 9) that require backtracking to pick up wind-up keys for the doll. See "Winding key locations" for details
        - After obtaining the 3 winding keys return to Zone 10 and use the winding keys on the automaton doll  
        - Now walk into the corrosion sentry's line-of-sight, the automaton will activate, and the corrosion sentry will give chase > "Unspotted" flag triggered
...
## "[10] 1F Servant's Quarters Corrosion Sentry"
