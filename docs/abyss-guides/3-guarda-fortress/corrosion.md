...
![](./img/corr-register-corrosion-sentry-steps.png){ width="900" style="display: block; margin: 0 auto;" }
        ...
        === "Exiting from Zone 2 Fountain"
            ...
            ??? note "Path to Zone 3 Harken"
                ...
                === "Boss: Necrocore"
                    ...
                    - Necrocore is undead and requires Expulsion weapons to do full damage
                    - Its "Spear of Doom" attack can insta-kill an adventurer. To increase insta-kill tolerance:
...
??? warning "Important Notes for [3] and [4]"
    ...
    === "Registration"
        ...
        !!! tip "Corosion sentry [9] requires a low Abyss corrosion level to access the room. Make sure you toggle all corrosion sentry toggles to "Not spotted" beforehand"
        ...
        === "Spotted"
            ...
            - To the south is corrosion sentry [3] that can be registered in the same run
                ...
                ??? bug "Potential Exploit" 
                    ...
                    - Some players have reported a bug that can trigger the "Spotted" flag without defeating the Necrocore boss 
                    - Steps
                        - Wheel to Enshadowed Well of Life (Zone 2 Fountain), get "Spotted", and then exit via a Hook of Harken or the Zone 1 Harken
                    ...
                    - The bug may have been patched, so proceed at your own risk
...
??? note "2F North Corrosion Sentry [8]"
    ...
    ??? warning "Cursed Wheel Registration"
        ...
        === "Not Spotted"
            ...
            - Warning! Do not use the bottom-left drop-down as you will be "Spotted" when you land 
...
!!! danger "Read Me - Critical Bug"
    ...
    === "What is the bug?"
        ...
        - Update! Some players have reported successfully registering sentries after reaching Ixion's room and interacting with the NPCs inside. Instead of heading to the GWO fight you would return to the Fountain and take the portal to the Z9 Harken to exit. This has not been tested extensively, so do so at your own risk.  
    ...
    === "How to Register"
        ...
        - When you reach Ixion's speak to Dalian (GWO 8, Blackmail) or Clemente (GWO 6, Mastermind) and hand over the evidence.
    ...
    === "Other Notes" 
        ...
        - Corrosion sentry [10]: [Search for the Missing Girl](./requests.md#search-for-the-missing-girl)
            ...
            - Each of the 3 endings (outcomes) has a Cursed Wheel toggle. You do not need to repeat it every time you fight the GWO. 
        - Corrosion sentry [12]: [Blackmail Resolution](./requests.md#blackmail-resolution)        
            - Requires a key to enter the room below the Z9 Harken that you will receive as part of the request.
...
??? note "1F Servant's Quarters Corrosion Sentry [10] [LC]<span style="color: LimeGreen">*</span>"
    ...
    ??? warning "Cursed Wheel Registration"
        ...
        === "Not Spotted"
            ...
            - Start: Fortress 2F Minor Harken (Zone 9 Harken) 
            - Register: 
                - Blackmail (GWO 8) or Mastermind (GWO 6) ending 
                - Encounter the GWO, you can have the MC die ("Accept Death") or defeat it
...
??? note "2F Soldier's Room Corrosion Sentry [12]"
    ...
    ??? warning "Cursed Wheel Registration"
        ...
        === "Spotted"
            ...
            - To exit head to the Zone 10 Fountain and then southern teleport to warp to the Zone 9 Harken
        ...
        === "Not Spotted"
            ...
            - Do not enter this room as move down the Zone 9 hallway to the Zone 8 drop-down point
            - To register you must head to the Zone 10 Fountain (do NOT exit) and then fight GWO 6 (Mastermind ending) or GWO 8 (Blackmail ending) as the registration node is Triumphant Return  
