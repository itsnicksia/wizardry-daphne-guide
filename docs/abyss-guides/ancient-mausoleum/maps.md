...
??? note "Bone Tallow"
    ...
    <small>adapted from [Efficient usage of Tallow of Bone Summoning - by BeautifulDemise](https://docs.google.com/document/d/1UiYnFerCGra0724tjVYY_Znvsz13ManglScVBo0Z91M/edit?usp=sharing)</small>  
    
    - Strategy 1: Simply use the tallows as you get them on the Mausoleum you want.  Lets say you want a Dino to increase your Montino level (for all those pesky Bronze trial and Abyss 2 caster groups! and because 1/4 is nice round maths), use the tallows in the Mage Mausoleum, and you'll have a 1/4 = 25% chance of getting what you want.  Do this every week and you're chance of getting a Dino in N weeks is P(N) = 1 - 0.75^N. (68% likelihood over 4 weeks of getting 1 Dino).
    - Strategy 2: Guarantee you get a Dino by using your tallows until you reset all 4 Mage Mausoleum bones, then go get all 4 bones. After four weeks you'll have a 4/4 =  100% chance of getting 1 Dino, with a 'success rate' of 25% (1 Dino, 3 not).
    - Strategy 3: You probably want more than one Dino (level 3 will take 4 copies), and would increased chances of getting him and not the others. You can do that by first following the Strategy 2 approach of resetting the whole Mausoleum to 0 (0/4 for Mages). Then, retrieve bones until you get Dino. At that point stop getting bones. Reset the Mage Mausoleum to 0 again. Then get bones again until you get Dino. Stop. Reset. Repeat.  At the best case you get Dino on the first run.  At the worst case, you repeat the Strategy 2 exercise and it takes 4 runs to get what you want.  You are still guaranteed a 100% chance of getting Dino in 4 runs or less. By resetting right after a succes, though, you will get fewer unwanted bones and on average (see link above for maths) you will have a higher success rate of 40% (4 Dino's in 10) versus the Strategy 2 of 25%.
    - Strategy 3.5: You can apply Strategy 3 to wanting more than one bone. Maybe both Asha and Dino for MONTINO and KATINO, or Jean and Bakesh for trap skills (2/6 from Thief Mausoleum).  In that case you run until you get the two you want, then reset.  Similar math applies, and the success rate will be higher than Strategy 1 or 2.  You can even get really fancy, and maybe you wouldn't mind Amelia's Stealth skill and value it ~half as much as trap skills.  You can use the 'liklihood of success' change as you collect bones to decide when to reset and incease overall success rate. 

??? note "Mausoleum Speed Running"
    !!! warning "Mausoleum enemies can be dangereous for lower level parties, and the fast movement of auto-walking increases chance of accidental ambushes when running into enemies. If you aren't confident of surviving ambushes, you're advise to just walk the path and make deliberate choices to trigger/ambush/avoid the enemies."
...
!!! map "Suggested Fast Chest Path with Minimal Fight Potential"   
