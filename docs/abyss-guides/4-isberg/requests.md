...
- You need to take a certain number of events (not sure exact amount at the moment), otherwise upon reaching the end, there will be no Bigfoot and the requests fails. Where the Baby Yeti stops is not random but there are many stops along the whole map.
