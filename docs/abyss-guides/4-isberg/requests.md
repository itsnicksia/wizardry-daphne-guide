...
??? "Overview"
    ...
    - Enemy level is (xx)
    - Some chests have unusually high Find/Disarm requirements even at 150/150
...
??? "Consult with a Physician"
    ...
    - Give the Slatewillow to Reimi and watch the ending. There is no known way of preventing this outcome 
...
??? "Consult with a Mystic"
    ...
    ??? "Aegon Route<span style="color: MediumOrchid">*</span>"
        ...
        - Aegon tells you about the Fellwisp and Sar-moon Herb ("Procurement of Medicinal Herbs" quest) 
        - Return to Elden Hill and enter the Witch's Cave 
        - Go north and down the stairs to BF2. Both items are located on this floor 
