...
5. Route 6's South Lakeshore adult will initially be located at X:14, Y:11. He will run away to X:11, Y:2. He will run away again to X:5, Y:1. Then finally, he will run away to X:1, Y:17. It will be a fight with several snow hawks, big snow hawks, and himself. It's extremely pertinent that you kill him first, and then kill all the other enemies ASAP (within 2 turns or so), otherwise he will run away and completely ruin all progress made in this ending. You will need to cursed wheel and start over finding every adult again.
