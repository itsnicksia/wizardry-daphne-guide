      ...
      items: [
        {
          ...
          details: 'A new set of 4 to 6 Adventurer’s Remains is available in the Crucible Mausoleum every 2 weeks.',
          reset: { 
        ...
        },
        {
          ...
          details: 'Furnace of Deathsmoke located at the Ancient Mausoleum floor selection screen. Produces one Tallow every [7 Days].',
        ...
        },
        {
          ...
          details: 'The wandering Bone Picker will sell you one Tallow for 10,000 Gold every [7 Days].',
    ...
    },
    {
      ...
      items: [
        { subheader: 'Beginning Abyss' },
        {
          ...
          details: 'Located in the tutorial area and cannot be missed. [30 Days]',
        ...
        { subheader: 'Other'},
        {
          ...
          details: 'The wandering Bone Picker will sell you one set of Adventurer’s Remains for 1,000 Gold every [7 Days].',
          image: '/abyss-guides/1-beginning-abyss/img/a1-bone-picker.jpg', 
          clickable: true
        }
      ]
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          details: 'Chest in B5F Southwest 3-chest room (x:8, y:2). [2 Days]',
        ...
        },
        {
          ...
          details: 'Chest in B5F East 3-chest room (x:22, y:15). [7 Days]',
        ...
        },
        {
          ...
          details: 'Chest in B8F (x:0, y:22). [24 Hours]',
        ...
        },
        {
          ...
          details: 'Chest in B8F (x:19, y:12). [24 Hours]',
        ...
        { subheader: 'Chest Items' },
        {
          ...
          details: 'Chest in 1st District behind locked door (x:10, y:22). [30 Days]',
        ...
        },
        {
          ...
          title: 'Nourishing Draught x3',
          details: 'Chest in 2nd District southeast room (x:21, y:10). [30 Days]',
        ...
        },
        {
          ...
          title: 'Light Sandals',
          details: 'Chest in 3rd District near ambush room (x:17, y:1). [30 Days]',
        ...
        },
        {
          ...
          details: 'Chest in 4th District near Harken room (x:26, y:20). [30 Days]',
        ...
        },
        {
          ...
          details: 'Chest in 4th District in the northwest room (x:0, y:22). [7 Days]',
        ...
        },
        {
          id: 'man_eater',
          title: 'Man-Eater',
          details: 'Chest in 5th District (x:6, y:23). [30 Days]',
        ...
        },
        {
          ...
          details: 'Chest in 6th District (x:7, y:22). [30 Days]',
        ...
        },
        {
          ...
          details: 'Chest in Ship 2 Treasure Room (x:14, y:13) with 2x Deep-Water Gleaming Crystals. [30 Days]',
        ...
        { subheader: 'Request Rewards' },
        {
          id: 'bird_dropper',
          title: 'Bird-Dropper',
          details: 'Request Reward from "Hydra Plant Procurement". [30 Days]',
          image: '',
          clickable: false,
        },
        {
          ...
          details: 'Request Reward from "Servant and Cargo Recovery" (select "Turn them all over to the merchant"). [30 Days]',
          image: '',
          clickable: false,
        },
        {
          ...
          details: 'Defeat Octonarus after giving Melgina the Mackerel Sandwich. [30 Days]',
          image: '',
          clickable: false,
        },
        {
          ...
          details: 'Defeat Octonarus after giving Melgina the Titanium Knife. [30 Days]',
          image: '',
          clickable: false,
        },
        {
          ...
          details: 'Choose "Octonarus‘s Cherished Sword" after defeating Octonarus. [30 Days]',
          image: '',
          clickable: false,
        },
        {
          ...
          details: 'Request Reward from "Missing Person (Princess Route)". [30 Days]',
          image: '',
          clickable: false,
        },
        {
          ...
          details: 'Request Reward from "Missing Person (Pontiff Route)". [30 Days]',
          image: '',
          clickable: false,
        },
        {
          ...
          title: 'Twin Pearls',
          details: 'Request Reward from "Missing Person (Admiral Route)". [30 Days]',
          image: '',
          clickable: false,
        },
        {
          ...
          details: 'Quest Reward from "Arena Tournament by Avare". [30 Days]',
          image: '',
          clickable: false,
        },
        ...
        },
        {
          ...
          details: 'Chest in Zone 2 (x:23, y:25). Requires low corrosion (exact level uncertain). [30 Days]',
        ...
        },
        {
          ...
          details: 'Chest in Zone 6 (x:24, y:14). [30 Days]',
        ...
        },
        {
          id: 'a3_z9_mana_pots',
          title: 'Mana Elixir x3',
          details: 'Chest in Zone 9 (x:16, y:0). [30 Days]',
        ...
        { subheader: 'Request Rewards' },
        {
          ...
          details: 'Quest Reward from "Putting Evil Spirits to Rest". [30 Days]',
          image: '',
          clickable: false,
        },
        {
        ...
        },
        {
          ...
          title: 'Goatskin Cloak',
          details: 'Request Reward from "Antique Scarlet Doll". Select handing all the dolls in. [30 Days]',
          image: '',
          clickable: false,
        },
        {
          ...
          details: 'Request Reward from "Antique Scarlet Doll". Select handing no dolls in. [30 Days]',
          image: '',
          clickable: false,
        },
        {
          ...
          details: 'Request Reward from "Expedition to Clear the Fortress Lower Levels". [30 Days]',
          image: '',
          clickable: false,
        },
        {
          ...
          details: 'Reward from beating Morgus, God of Death. [30 Days]',
          image: '',
          clickable: false,
        },
        {
          ...
          details: 'Admiral Route Clear Reward. [30 Days]',
          image: '',
          clickable: false,
        },
        {
          ...
          details: 'Princess Route Clear Reward. [30 Days]',
          image: '',
          clickable: false,
        },
        {
        ...
        },
        {
          ...
          details: 'Request Reward from Cleanup Operation quest reward. [30 Days]',
          image: '',
          clickable: false,
        },
        {
          ...
          details: 'Request Reward from "Requiem for the Evil Spirit" quest. [30 Days]',
          image: '',
          clickable: false,
        },
        { subheader: 'Deepsnow Hinterlands' },
        ...
        },
        {
          id: 'a4_r10_mana_pots',
          title: 'Mana Elixir x3',
          details: 'Route 10 (x:18, y:7). [30 Days]',
          image: '',
          clickable: false,
        },
        ...
        },        
        {
          ...
          details: 'Top of the house. (x:12, y:24). [30 Days]',
          image: '',
          clickable: false,
        },        
        {
          ...
          details: 'Guarded by miniboss, next to Nourishing Draughts. (x:2, y:0). [30 Days]',
          image: '',
          clickable: false,
        },        
        {
          ...
          details: 'Above Church. In blizzard. (x:17, y:26). [30 Days]',
          image: '',
          clickable: false,
        },
        { subheader: 'Request Rewards' },
